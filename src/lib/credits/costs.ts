 ...
 * New companies receive 10,000,000 free tokens.
 */
...
/** Token costs per operation unit */
...
export function llmChatTokens(promptTokens: number, completionTokens: number): number {
...
export function ocrProviderToTokenKey(
    ...
    if (normalized.includes("datalab") || normalized.includes("marker")) return "datalab";
    return "native";
}
