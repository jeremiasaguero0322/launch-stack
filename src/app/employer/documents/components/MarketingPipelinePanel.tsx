...
import { Copy, Loader2, Megaphone, MessageSquareText, Pencil, Sparkles } from "lucide-react";
  ...
  const runPipeline = async () => {
    ...
    try {
      const response = await fetch("/api/marketing-pipeline", {
        ...
        body: JSON.stringify({ platform, prompt: normalizedPrompt }),
      });
      ...
      if (!response.ok || !payload.success || !payload.data) {
        // Show detailed error when API returns it (e.g. "OpenAI API key not configured")
        const message =
          payload.message ?? "We couldn't generate a campaign right now. Please try again.";
                ...
                <div className={styles.sessionPanel}>
                  ...
                  {sessions.length === 0 ? (
                    <p className={styles.sessionEmpty}>
                      No saved sessions yet. Generate a campaign to create one.
                    </p>
                  ) : (
                  ...
                  <div className={styles.workspaceLeft}>
                    <header className={styles.workspaceLeftHeader}>
                      <div className={styles.selectedPlatformPill}>
                        ...
                        <span className={styles.selectedPlatformLabel}>
                            ...
                            >
                              <SheetHeader className="px-6 pt-6 pb-4 border-b shrink-0">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Use tone, length, and audience options to refine the message.
                                  Preview and accept when you&apos;re happy.
                                </p>
                              </SheetHeader>
