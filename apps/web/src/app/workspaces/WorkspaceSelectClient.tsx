    ...
    return (
        <div className={styles.body}>
            ...
            <div className={styles.topbar}>
                ...
                <div className={styles.me} title="Signed in">
            ...
            <div className={styles.wrap}>
                ...
                <header className={styles.header}>
                    ...
                    <p className={styles.hSub}>
                        ...
                        workflows live. Open one you&apos;re already in, or start a
                        new one for a different company or project.
                    </p>
                </header>
                ...
                <div className={styles.searchRow}>
                    <div className={styles.search}>
                        ...
                        <input
                            ...
                            placeholder="Search workspaces by name, URL, or role…"
                            autoComplete="off"
                        ...
                        filtered.map((ws) => {
                            ...
                            return (
                                <button
                                    key={ws.id}
                                    type="button"
                                    className={`${styles.ws} ${ws.isActive ? styles.wsActive : ""}`}
                                ...
                                >
                                    ...
                                    <div className={styles.pile} aria-label="Members">
                                        <span
                                            className={styles.av}
                                            style={{
                                                background: SWATCH_GRADIENTS[ws.swatch] ?? SWATCH_GRADIENTS[1],
                                            }}
                                        >
                                            {initials.slice(0, 2)}
                                        </span>
                        ...
                        <div className={styles.ceGrid}>
                            ...
                            <div className={`${styles.ceField} ${styles.ceFieldFull}`}>
                                ...
                                <textarea
                                    ...
                                    rows={2}
                                    placeholder="One sentence on what this company does."
                                    value={description}
